...
class OpenAI extends Core.APIClient {
     ...
     */
    constructor({ baseURL = Core.readEnv('OPENAI_BASE_URL'), apiKey = Core.readEnv('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'), organization = Core.readEnv('OPENAI_ORG_ID') ?? null, ...opts } = {}) {
        if (apiKey === undefined) {
